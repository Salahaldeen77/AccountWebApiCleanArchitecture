...
namespace AccountWeb.Core.Bases
{
    public class ResponseHandler
    {
        ...
        public Response<T> Deleted<T>(object Meta = null, string message = null)
        {
        ...
        public Response<T> NotFound<T>(object Meta = null, string message = null)
        {
            return new Response<T>()
            {
